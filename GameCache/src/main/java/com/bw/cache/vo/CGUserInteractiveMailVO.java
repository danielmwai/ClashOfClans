...
public class CGUserInteractiveMailVO implements Serializable {

    private static final long serialVersionUID = 5488704174556722326L;
    private long id;
    ...
    public boolean equals(final Object obj) {
        ...
        final CGUserInteractiveMailVO other = (CGUserInteractiveMailVO) obj;
    ...
    public String toString() {
        return "CGUserInteractiveMailVO [id=" + this.id + ", sender=" + this.sender + ", receiver=" + this.receiver + ", mailType=" + this.mailType + ", lastModify=" + this.lastModify + ", buildingId=" + this.buildingId + "]";
    }
}
